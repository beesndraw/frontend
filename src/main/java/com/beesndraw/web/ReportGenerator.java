...
public class ReportGenerator {
	...
	private static void saveReport(Report report, String string) throws Exception {
	...
	private static Report prepareReport(List<Trade> trades) throws ParseException {
		Report report = new Report(trades);
		return report;
	}

	private static List<Trade> getTrades(List<String> records) {
